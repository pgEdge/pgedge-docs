...
These images are validated for use with [CloudNativePG](https://cloudnative-pg.io/), the Kubernetes operator for PostgreSQL. pgEdge tests compatibility through automated end-to-end testing against the upstream CloudNativePG test suite.
