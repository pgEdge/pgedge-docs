...
account with pgEdge. To 
[link a cloud account](../prerequisites/cloud_accounts/index.md),
select the `Cloud Accounts` menu option in the Cloud console's left
navigation pane.

pgEdge Cloud can create and manage clusters created on:

* AWS
* Azure
* Google

When you create a cluster, pgEdge will provision the cluster using resources
available to your cloud account.
