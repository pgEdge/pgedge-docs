...
!!! warning "Review Release Notes"
    Always review the [CloudNativePG release notes](https://cloudnative-pg.io/releases/) before upgrading. Some versions may have specific requirements or breaking changes.
