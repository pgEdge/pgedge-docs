...
- helm charts and manifests for deploying the operator.
- a kubectl plugin for cluster management.
- validated compatibility with pgEdge Enterprise Postgres images.
- commercial support from pgEdge.

[Get started with pgEdge Enterprise Postgres on Kubernetes](../kubernetes/index.md)
...
The Container Registry features:

- pre-built images with extensions installed.
- multi-architecture support (amd64, arm64).
- regular security updates.

[Browse the pgEdge Container Registry](../container-images/index.md)
