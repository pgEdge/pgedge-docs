...
## v25.1.0 on 2025-07-09
  ...
  - You can now use the `pg_data` flag with the [setup](../platform/pgedge_commands/setup/index.md) command and in your [cluster.json](../platform/installing_pgedge/json.md) file to specify a non-default location for your Postgres `data` directory.
